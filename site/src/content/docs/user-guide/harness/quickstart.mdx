...
[`harness-py`](https://github.com/strands-agents/harness-sdk/tree/main/harness-py) (Python)
and [`harness-ts`](https://github.com/strands-agents/harness-sdk/tree/main/harness-ts)
(TypeScript).
